	...
	public Dimension getSize(JTable table) {
		...
		while (e.hasMoreElements()) {
			...
			if (obj instanceof TableColumn) {
				...
				width += aColumn.getWidth() - table.getIntercellSpacing().width; // Ruben Gomez -> Linea corregida: hay que restar el inercellspacing.width
				width += margin;
			} else {
				width += ((ColumnGroup)obj).getSize(table).width  -table.getIntercellSpacing().width; // Ruben Gomez -> Linea corregida: hay que restar el inercellspacing.width
			}
		}
